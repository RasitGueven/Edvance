...
import { Clock, Pencil, Lightbulb, ChevronDown, ChevronUp, Sparkles, CheckCircle2 } from 'lucide-react'
...
type FocusSkill = { skill_cluster: string; level: number; label: string }
