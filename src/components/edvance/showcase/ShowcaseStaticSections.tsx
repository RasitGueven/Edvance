// Static (non-interactive) sections for the DesignShowcase page.
...
import { Section } from './ShowcaseSection'
      ...
      <div className="grid grid-cols-2 gap-4">
        {[
          ...
          <EdvanceCard key={group}>
            <p className="text-xs font-semibold uppercase tracking-widest text-[var(--text-muted)] mb-4">{group}</p>
    ...
    <Section title="EdvanceCard – Varianten & Accents">
      <div className="grid grid-cols-2 gap-4">
        <EdvanceCard variant="default">
          ...
          <p className="text-sm text-[var(--text-secondary)] leading-relaxed">Standard-Card mit weißem Hintergrund. Für den meisten Content.</p>
        </EdvanceCard>
        ...
        <EdvanceCard variant="navy">
          ...
          <p className="text-sm leading-relaxed opacity-80">Navy-Hintergrund. Für Header-Bereiche oder primäre Highlights.</p>
        </EdvanceCard>
        <EdvanceCard variant="blue-pale">
          ...
          <p className="text-sm text-[var(--text-secondary)] leading-relaxed">Helles Blau. Für Info-Boxen oder Onboarding-Hinweise.</p>
        </EdvanceCard>
      </div>
      <div className="grid grid-cols-2 gap-4">
        {(['left-primary', 'left-success', 'left-warning', 'left-destructive'] as const).map((accent) => (
          <EdvanceCard key={accent} accent={accent}>
            <p className="text-xs font-semibold uppercase tracking-wider text-[var(--text-muted)] mb-1">accent: {accent}</p>
