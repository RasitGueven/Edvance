            ...
            <div className="flex flex-col items-center gap-1.5 min-w-0">
              <div
                className={cn(
                  ...
                  isPast   && 'bg-[var(--color-success-eltern)] border-[var(--color-success-eltern)] text-white',
              ...
              <span
                className={cn(
                  ...
                  isPast   && 'text-[var(--color-success-eltern)]',
            ...
            {!isLast && (
              <div
                className={cn(
                  ...
                  isPast ? 'bg-[var(--color-success-eltern)]' : 'bg-[var(--color-border)]',
                )}
              />
            )}
          </Fragment>
