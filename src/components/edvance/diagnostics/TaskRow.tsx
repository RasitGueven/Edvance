// TaskRow – editable row for a single diagnostic task (admin DiagnosticsPage).
    ...
    <EdvanceCard className="flex flex-col gap-3 p-5">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <select
          ...
          onChange={(e) => setEdit({ ...edit, difficulty: e.target.value ? Number(e.target.value) : null })}
        >
        ...
        <select
          ...
          onChange={(e) => setEdit({ ...edit, input_type: (e.target.value || null) as InputType | null })}
        >
        ...
        <select
          ...
          onChange={(e) => setEdit({ ...edit, cognitive_type: (e.target.value || null) as CognitiveType | null })}
        >
