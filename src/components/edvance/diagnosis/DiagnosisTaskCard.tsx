...
import { Clock, Pencil, Lightbulb, ChevronDown, ChevronUp } from 'lucide-react'
import type { BehaviorAnalysis, BehaviorSnapshot } from '@/types/diagnosis'
import type { RunTask } from '@/types'
import { SIGNAL_LABELS, formatDuration } from './diagnosisUtils'
import { SmallBadge, MiniMetric, FlagTag, KV } from './DiagnosisResultComponents'
