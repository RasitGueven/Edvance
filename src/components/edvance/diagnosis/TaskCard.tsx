// TaskCard – expandable per-task detail card used in DiagnosisResult.
...
import { SIGNAL_LABELS, formatDuration, SmallBadge, KV, MiniMetric } from './ResultUtils'
              ...
              {analysis.flags.length > 0 && (
                <div className="flex flex-wrap gap-1.5">
                  {analysis.flags.map(f => (
                    ...
                    >
                      <span className="h-1.5 w-1.5 rounded-full inline-block" style={{ background: 'var(--primary)' }} />
                      {f}
                    </span>
                  ))}
                </div>
