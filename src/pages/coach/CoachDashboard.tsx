...
const ICON_BG_PRIMARY = 'color-mix(in srgb, var(--color-primary) 12%, transparent)'
const ICON_BG_SUCCESS = 'color-mix(in srgb, var(--color-success) 12%, transparent)'
const ICON_BG_WARNING = 'color-mix(in srgb, var(--color-gold-warning) 12%, transparent)'
