    ...
    <div id="lernpfad" className="flex flex-col gap-3">
      <div className="relative">
        ...
        <input
          ...
          className="h-12 w-full rounded-[var(--radius-md)] border border-[var(--color-border)] bg-[var(--color-bg-surface)] pl-11 pr-11 text-sm shadow-xs focus:border-[var(--color-primary)] focus:outline-none transition-colors"
        />
        {search && (
          <button
            type="button"
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 rounded-[var(--radius-sm)] p-1 text-[var(--color-text-tertiary)] hover:bg-[var(--color-bg-app)] hover:text-[var(--color-text-primary)]"
          >
            <X className="h-4 w-4" />
          </button>
        )}
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        {isFiltering && (
          <button
            type="button"
            onClick={onClear}
            className="ml-auto text-xs font-semibold text-[var(--color-text-tertiary)] hover:text-[var(--color-text-primary)]"
          >
            Filter zurücksetzen
          </button>
        )}
