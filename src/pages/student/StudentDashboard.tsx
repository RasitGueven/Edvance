...
import { Search, X, Flame, FlaskConical, BookOpen } from 'lucide-react'
...
import { StudentClusterGrid } from '@/components/edvance/StudentClusterGrid'
import { StudentFilterResults } from '@/components/edvance/StudentFilterResults'
    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        {isFiltering ? (
          ...
          <StudentClusterGrid clusters={clusters} />
        )}
      </main>
    </div>
  )
