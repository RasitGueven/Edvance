...
import { XPBar, LoadingPulse, EmptyState } from '@/components/edvance'
      ...
      <main className="mx-auto max-w-3xl px-4 py-8">
        ...
        {isFiltering ? (
          ...
          <EmptyState
            ...
            description="Noch keine Themen verfügbar. Frag deinen Coach."
          />
        ) : (
  ...
  if (tasks.length === 0) {
    return (
      <EmptyState
        icon="🔍"
        title="Keine Treffer"
        description="Versuch es mit einem anderen Suchbegriff oder Filter."
      />
    )
  }
  return (
