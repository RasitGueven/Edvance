// Static showcase sections extracted from DesignShowcase.tsx for size compliance.
...
export function ShowcaseTypografie() {
  return (
...
export function ShowcaseSchatten() {
  return (
...
export function ShowcaseFarben() {
  return (
...
export function ShowcaseSpacing() {
  return (
    ...
    <Section title="EdvanceCard – Varianten & Accents">
      <div className="grid grid-cols-2 gap-4">
        ...
        <EdvanceCard variant="navy">
          ...
          <p className="text-sm leading-relaxed opacity-80">Navy-Hintergrund.</p>
        </EdvanceCard>
...
export function ShowcaseBadgesAndBars() {
  return (
    <>
...
export function ShowcaseStatAndAvatar() {
  return (
    <>
...
export function ShowcaseProgressAndEmpty() {
  return (
    <>
