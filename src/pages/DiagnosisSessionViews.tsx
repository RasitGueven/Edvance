...
function CoachInfoBox({
  icon, title, color, bg, text,
}: {
  icon: React.ReactNode; title: string; color: string; bg: string; text: string
}) {
  return (
    <div
...
export function SetupScreen({ view, screening = false }: { view: 'student' | 'coach'; screening?: boolean }) {
