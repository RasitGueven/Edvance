...
import { NewTaskForm } from '@/components/edvance/diagnostics/NewTaskForm'
import { TaskRow } from '@/components/edvance/diagnostics/TaskRow'
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto flex max-w-3xl flex-col gap-6 px-4 py-8">
        <div>
          <Link to="/admin" className="mb-2 flex items-center gap-1 text-sm text-[var(--text-muted)]">
            <ArrowLeft className="h-4 w-4" /> Admin
          </Link>
          <h1 className="text-2xl font-bold text-[var(--text-primary)]">Diagnostik-Content</h1>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <select className={SELECT_CLASS} value={clusterId} onChange={(e) => loadTasks(e.target.value)}>
