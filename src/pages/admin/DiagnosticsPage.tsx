...
const SELECT_CLASS =
  'h-10 rounded-xl border border-[var(--color-border)] bg-[var(--card)] px-2 text-sm'
  ...
  return (
    <EdvanceCard className="flex flex-col gap-4 p-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          id="d-q"
          className="min-h-[80px] rounded-xl border border-[var(--color-border)] bg-[var(--card)] px-3 py-2 text-sm"
          value={form.question}
      ...
      <div className="flex flex-col gap-2">
        ...
        <textarea
          id="d-s"
          className="min-h-[60px] rounded-xl border border-[var(--color-border)] bg-[var(--card)] px-3 py-2 text-sm"
          value={form.solution ?? ''}
