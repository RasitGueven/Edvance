    ...
    <SessionShell maxWidth="md" showExit>
      <div className="flex flex-col gap-6">
        <div className="text-center">
          <p className="text-eyebrow text-white/55">{t('session.complete.eyebrow')}</p>
        ...
        <EdvanceCard variant="glass" className="text-white">
          <div className="flex items-center justify-between gap-4">
            <span className="text-sm text-white/70">{t('session.complete.xpLabel')}</span>
            <span className="animate-count-up text-3xl font-bold text-[var(--color-gold-champagner)]">
              +{earnedXp}
              <span className="ml-1 text-base text-white/70">{t('session.common.xpUnit')}</span>
            </span>
          </div>
        </EdvanceCard>
        ...
        <EdvanceCard variant="glass" className="text-white">
          <div className="flex items-center justify-between gap-3">
            <span className="text-sm text-white/70">{t('session.complete.streakLabel')}</span>
        ...
        <EdvanceCard variant="glass" className="text-white">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-sm leading-relaxed text-white/90">{student.coachNote}</p>
            </div>
          </div>
        </EdvanceCard>
