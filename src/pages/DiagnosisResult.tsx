...
import { GaugeCard } from '@/components/edvance/diagnosis/RadialGauge'
import { KpiCard } from '@/components/edvance/diagnosis/KpiCard'
import { SkillBar } from '@/components/edvance/diagnosis/SkillBar'
import { TaskCard } from '@/components/edvance/diagnosis/TaskCard'
import { LernplanSection } from '@/components/edvance/diagnosis/LernplanSection'
import {
  DIAGNOSIS_TO_COMPETENCY,
  SectionHeader,
  FlagTag,
  formatDate,
  formatDuration,
  getInitials,
} from '@/components/edvance/diagnosis/ResultUtils'
import {
  Clock,
  Pencil,
  TrendingUp,
  ...
  useEffect(() => {
    ...
    void completeScreeningTest(
      state.screeningTestId,
      {
        ...
        averages: { confidence: avgConfidence, effort: avgEffort, frustration: avgFrustration },
      },
      state.coachNote,
    )
  }, [state.mode, state.screeningTestId, state.finished, state.coachNote, result, avgConfidence, avgEffort, avgFrustration])
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 py-8 pb-24">
        ...
        >
          <div className="absolute -top-12 -right-12 h-48 w-48 rounded-full opacity-10" style={{ background: 'white' }} />
          <div className="absolute -bottom-16 -left-16 h-56 w-56 rounded-full opacity-5" style={{ background: 'white' }} />
