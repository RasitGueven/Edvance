...
import {
  ...
  TaskCard,
  SectionHeader,
} from '@/components/edvance/DiagnosisResultComponents'
import {
  Clock,
  Pencil,
  Target,
...
// Wird genutzt um beim Klick auf einen Fokus-Cluster das echte Supabase-Cluster
// per Name zu finden und zur ClusterView zu navigieren.
...
export function DiagnosisResult() {
  ...
  // Screening-Ergebnis genau einmal persistieren (DB-Modus, fertig).
