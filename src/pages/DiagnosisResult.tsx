...
import {
  ...
  formatDuration,
  getInitials,
} from '@/components/edvance/diagnosis/diagnosisResultHelpers'
import {
  GaugeCard,
} from '@/components/edvance/diagnosis/RadialGauge'
import {
  KpiCard,
  FlagTag,
  SkillBar,
  SectionHeader,
  TaskCard,
} from '@/components/edvance/diagnosis/DiagnosisResultAtoms'
...
export function DiagnosisResult() {
  ...
  // Screening result persisted exactly once (DB mode, finished)
