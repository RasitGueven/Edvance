// Sub-components and helpers for DiagnosisResult page.
// Extracted to keep DiagnosisResult.tsx under the 400-line limit.

import { useState } from 'react'
import { Link } from 'react-router-dom'
import { ChevronDown, ChevronUp, Clock, Pencil, Lightbulb, CheckCircle2, Sparkles } from 'lucide-react'
...
export function ResultHeroHeader({
  studentName,
  subject,
  date,
}: {
...
export function LernplanSection({
  focus,
  clusterIdFor,
}: {
  focus: { skill_cluster: string; level: number; label: string }[]
