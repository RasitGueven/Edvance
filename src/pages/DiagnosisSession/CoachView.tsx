...
import { BehaviorBadge, CoachInfoBox, ProgressBar } from './shared'
import { AlertCircle, ArrowRight, CheckCircle2, Clock, Lightbulb, Pencil } from 'lucide-react'
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-8">
      ...
      <div className="mt-6 flex justify-end">
        <Link
          to="/diagnosis/result"
          className="text-xs font-bold uppercase tracking-wider text-muted hover:text-foreground flex items-center gap-1"
        >
