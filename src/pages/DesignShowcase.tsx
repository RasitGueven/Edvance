...
import { EdvanceBadge, ToastBanner } from '@/components/edvance'
import {
  ShowcaseTypografie,
  ShowcaseSchatten,
  ShowcaseFarben,
  ShowcaseSpacing,
  ShowcaseCards,
  ShowcaseBadgesAndBars,
  ShowcaseStatAndAvatar,
  ShowcaseProgressAndEmpty,
} from './DesignShowcaseSections'
    ...
    <div className="min-h-full bg-[var(--background)] pb-16">
      ...
      <div className="px-8 py-10 flex flex-col gap-14 max-w-5xl mx-auto">
        ...
        <Section title="Animationen – Demo">
          <div className="rounded-[var(--radius-xl)] p-6 bg-[var(--surface)] border border-[var(--border)] shadow-premium-sm flex flex-col gap-5">
        ...
        <Section title="ToastBanner – alle Typen">
          <div className="rounded-[var(--radius-xl)] p-6 bg-[var(--surface)] border border-[var(--border)] shadow-premium-sm flex flex-col gap-4">
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
